const KEYS = {
  ...
  gateIn: 'vlc.gateInData', gateOut: 'vlc.gateOutData', gateInMeta: 'vlc.gateInMeta', gateOutMeta: 'vlc.gateOutMeta'
};
...
export const dataStore = {
  ...
  getGateIn: () => read(KEYS.gateIn), getGateOut: () => read(KEYS.gateOut), getGateInMeta: () => read(KEYS.gateInMeta, {}), getGateOutMeta: () => read(KEYS.gateOutMeta, {}),
