...
- V3 hardening: canonical Excel business dates are emitted as YYYY-MM-DD strings before storage. Static Pages bundle is versioned to prevent stale cached app.js from masking date fixes.
